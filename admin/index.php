                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            ...
                            <p class="mt-3 fs-15 fw-medium">FUHSI CBT Admin Dashboard</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                        ...
                        <?php
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Sign in to continue to CBT.</p>
                                </div>
                                <div class="p-2 mt-4">
...
<!-- Mirrored from themesbrand.com/velzon/html/default/auth-signin-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 11 Dec 2022 11:13:56 GMT -->
